...
'D:\S.O.F.T.S\PIRENEA\PYTHON\sofa\src\gui\main_window_qt.ui'
#
...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.dockWidget_DataSelector.setFeatures(
            QtWidgets.QDockWidget.DockWidgetFloatable | QtWidgets.QDockWidget.DockWidgetMovable)
        self.dockWidget_DataSelector.setAllowedAreas(
        ...
        MainWindow.addDockWidget(
            QtCore.Qt.DockWidgetArea(1), self.dockWidget_DataSelector)
        self.dockWidget_Parameters = ParametersGUI(MainWindow)
        self.dockWidget_Parameters.setFeatures(
            QtWidgets.QDockWidget.DockWidgetFloatable | QtWidgets.QDockWidget.DockWidgetMovable)
        self.dockWidget_Parameters.setAllowedAreas(
            QtCore.Qt.LeftDockWidgetArea | QtCore.Qt.RightDockWidgetArea)
        ...
        MainWindow.addDockWidget(
            QtCore.Qt.DockWidgetArea(1), self.dockWidget_Parameters)
        self.dockWidget_Analysis = AnalysisGUI(MainWindow)
        self.dockWidget_Analysis.setMinimumSize(QtCore.QSize(1000, 203))
        self.dockWidget_Analysis.setFeatures(
            QtWidgets.QDockWidget.DockWidgetFloatable | QtWidgets.QDockWidget.DockWidgetMovable)
        self.dockWidget_Analysis.setAllowedAreas(
        ...
        MainWindow.addDockWidget(
            QtCore.Qt.DockWidgetArea(8), self.dockWidget_Analysis)
        self.dockWidget_MassTabSelector = MassTabSelectorGUI(MainWindow)
        self.dockWidget_MassTabSelector.setFeatures(
            QtWidgets.QDockWidget.DockWidgetFloatable | QtWidgets.QDockWidget.DockWidgetMovable)
        self.dockWidget_MassTabSelector.setAllowedAreas(
            QtCore.Qt.LeftDockWidgetArea | QtCore.Qt.RightDockWidgetArea)
        self.dockWidget_MassTabSelector.setObjectName(
            "dockWidget_MassTabSelector")
        self.dockWidgetContents_4 = QtWidgets.QWidget()
        self.dockWidgetContents_4.setObjectName("dockWidgetContents_4")
        self.dockWidget_MassTabSelector.setWidget(self.dockWidgetContents_4)
        MainWindow.addDockWidget(
            QtCore.Qt.DockWidgetArea(2), self.dockWidget_MassTabSelector)
        self.dockWidget_MassTabViewer = MassTabViewerGUI(MainWindow)
        self.dockWidget_MassTabViewer.setAllowedAreas(
            QtCore.Qt.BottomDockWidgetArea | QtCore.Qt.TopDockWidgetArea)
        ...
        MainWindow.addDockWidget(
            QtCore.Qt.DockWidgetArea(4), self.dockWidget_MassTabViewer)
